# Comparing `tmp/pysailfish-1.4.0.tar.gz` & `tmp/pysailfish-1.5.0.tar.gz`
...
### Comparing `pysailfish-1.4.0/pysailfish/internal/MT_EA/trade_functions.py` & `pysailfish-1.5.0/pysailfish/internal/MT_EA/trade_functions.py`
