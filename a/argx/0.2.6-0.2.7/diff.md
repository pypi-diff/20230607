# Comparing `tmp/argx-0.2.6.tar.gz` & `tmp/argx-0.2.7.tar.gz`
...
+gzip compressed data, was "argx-0.2.7.tar", max compression
```

## Comparing `argx-0.2.6.tar` & `argx-0.2.7.tar`
...
+-rw-r--r--   0        0        0     1063 2023-06-07 02:27:49.059379 argx-0.2.7/LICENSE
+-rw-r--r--   0        0        0    14316 2023-06-07 02:27:49.059379 argx-0.2.7/README.md
+-rw-r--r--   0        0        0      151 2023-06-07 02:27:49.059379 argx-0.2.7/argx/__init__.py
+-rw-r--r--   0        0        0     6571 2023-06-07 02:27:49.059379 argx-0.2.7/argx/action.py
+-rw-r--r--   0        0        0     3956 2023-06-07 02:27:49.059379 argx-0.2.7/argx/formatter.py
+-rw-r--r--   0        0        0    20435 2023-06-07 02:27:49.059379 argx-0.2.7/argx/parser.py
+-rw-r--r--   0        0        0      717 2023-06-07 02:27:49.059379 argx-0.2.7/argx/type_.py
+-rw-r--r--   0        0        0     2610 2023-06-07 02:27:49.059379 argx-0.2.7/argx/utils.py
+-rw-r--r--   0        0        0     1021 2023-06-07 02:27:49.059379 argx-0.2.7/pyproject.toml
+-rw-r--r--   0        0        0    15496 1970-01-01 00:00:00.000000 argx-0.2.7/setup.py
+-rw-r--r--   0        0        0    14938 1970-01-01 00:00:00.000000 argx-0.2.7/PKG-INFO
```

### Comparing `argx-0.2.6/LICENSE` & `argx-0.2.7/LICENSE`

 * *Files identical despite different names*

### Comparing `argx-0.2.6/README.md` & `argx-0.2.7/README.md`

 * *Files identical despite different names*

### Comparing `argx-0.2.6/argx/action.py` & `argx-0.2.7/argx/action.py`

 * *Files identical despite different names*

### Comparing `argx-0.2.6/argx/formatter.py` & `argx-0.2.7/argx/formatter.py`

 * *Files identical despite different names*

### Comparing `argx-0.2.6/argx/parser.py` & `argx-0.2.7/argx/parser.py`
...
+            if not hasattr(ns, last_key) and isinstance(ns, Namespace):
...
### Comparing `argx-0.2.6/argx/type_.py` & `argx-0.2.7/argx/type_.py`

 * *Files identical despite different names*

### Comparing `argx-0.2.6/argx/utils.py` & `argx-0.2.7/argx/utils.py`

 * *Files identical despite different names*

### Comparing `argx-0.2.6/pyproject.toml` & `argx-0.2.7/pyproject.toml`
...
### Comparing `argx-0.2.6/setup.py` & `argx-0.2.7/setup.py`
...
### Comparing `argx-0.2.6/PKG-INFO` & `argx-0.2.7/PKG-INFO`
