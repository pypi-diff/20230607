# Comparing `tmp/sqlite_fastrand-0.2.1a6-py3-none-win_amd64.whl.zip` & `tmp/sqlite_fastrand-0.2.1a7-py3-none-win_amd64.whl.zip`

## zipinfo {}

```diff
@@ -1,10 +1,10 @@
-Zip file size: 619139 bytes, number of entries: 8
--rw-rw-rw-  2.0 fat        0 b- defN 23-Jun-07 18:09 noop.cp311-win_amd64.pyd
--rw-rw-rw-  2.0 fat      323 b- defN 23-Jun-07 18:09 sqlite_fastrand/__init__.py
--rw-rw-rw-  2.0 fat  1148928 b- defN 23-Jun-07 18:09 sqlite_fastrand/fastrand0.dll
--rw-rw-rw-  2.0 fat       81 b- defN 23-Jun-07 18:09 sqlite_fastrand/version.py
--rw-rw-rw-  2.0 fat      535 b- defN 23-Jun-07 18:09 sqlite_fastrand-0.2.1a6.dist-info/METADATA
--rw-rw-rw-  2.0 fat      102 b- defN 23-Jun-07 18:09 sqlite_fastrand-0.2.1a6.dist-info/WHEEL
--rw-rw-rw-  2.0 fat       21 b- defN 23-Jun-07 18:09 sqlite_fastrand-0.2.1a6.dist-info/top_level.txt
--rw-rw-r--  2.0 fat      669 b- defN 23-Jun-07 18:09 sqlite_fastrand-0.2.1a6.dist-info/RECORD
-8 files, 1150659 bytes uncompressed, 617961 bytes compressed:  46.3%
...
-Filename: sqlite_fastrand-0.2.1a6.dist-info/METADATA
+Filename: sqlite_fastrand-0.2.1a7.dist-info/METADATA
 Comment: 
 
-Filename: sqlite_fastrand-0.2.1a6.dist-info/WHEEL
+Filename: sqlite_fastrand-0.2.1a7.dist-info/WHEEL
 Comment: 
 
-Filename: sqlite_fastrand-0.2.1a6.dist-info/top_level.txt
+Filename: sqlite_fastrand-0.2.1a7.dist-info/top_level.txt
 Comment: 
 
-Filename: sqlite_fastrand-0.2.1a6.dist-info/RECORD
...
-Time/Date		Wed Jun  7 18:07:56 2023
...
-(format RSDS signature 37c78016e2794dd185cd58e2121d7cb7 age 1 pdb D:\a\sqlite-fastrand\sqlite-fastrand\target\release\deps\sqlite_fastrand.pdb)
...
-   1800025bf:	lea    -0x4c6(%rip),%rax        # 0x180002100
...
-   1800027af:	lea    -0xbf6(%rip),%rax        # 0x180001bc0
...
-   180002b8f:	lea    -0xe86(%rip),%rax        # 0x180001d10
...
-   180002d7f:	lea    -0xdd6(%rip),%rax        # 0x180001fb0
...
-   180002f6f:	lea    -0x1116(%rip),%rax        # 0x180001e60
...
-   18000334f:	lea    -0x1b86(%rip),%rax        # 0x1800017d0
...
-   18000353f:	lea    -0x1ad6(%rip),%rax        # 0x180001a70
...
-   18000372f:	lea    -0x14e6(%rip),%rax        # 0x180002250
...
-   18000391f:	lea    -0x23f6(%rip),%rax        # 0x180001530
...
-   180003b0f:	lea    -0x2496(%rip),%rax        # 0x180001680
...
+   180006c17:	jmp    0x18001e910
    ...
    180006c32:	pop    %rdi
    180006c33:	pop    %rsi
-   180006c34:	jmp    0x18001e870
+   180006c34:	jmp    0x18001e9b0
    180006c39:	nop
    180006c3a:	add    $0x28,%rsp
    180006c3e:	pop    %rdi
    180006c3f:	pop    %rsi
-   180006c40:	jmp    0x18001ef60
...
-   1800e9730:	xor    (%rbx,%riz,2),%esi
-   1800e9733:	movsxd (%rcx),%edi
-   1800e9735:	cmp    %esp,0x37(%rbx)
-   1800e9738:	(bad)
-   1800e9739:	xor    $0x36316165,%eax
-   1800e973e:	(bad)
-   1800e973f:	xor    $0x61,%al
-   1800e9741:	cmp    %ah,0x38(%rbx)
-   1800e9744:	(bad)
-   1800e9745:	(bad)
-   1800e9746:	xor    (%rdx,%rsi,1),%dh
-   1800e9749:	cmp    %ah,0x62(%rcx)
-   1800e974c:	xor    (%rdx),%dh
-   1800e974e:	fs ss xor $0x37626239,%eax
-   1800e9755:	movsxd (%rcx),%di
+   1800e9730:	(bad)
...
-   1800fbee4:	jl     0x1800fbead
-   1800fbee6:	andb   $0x0,0x0(%rax,%rax,1)
-   1800fbeeb:	add    %al,(%rdx)
-   1800fbeed:	add    %al,(%rax)
-   1800fbeef:	add    %ah,0x0(%rbp)
-   1800fbef2:	add    %al,(%rax)
-   1800fbef4:	movabs 0xfafa0000fc1,%al
...
-   1800fbeff:	add    %bh,-0x80(%rdi,%rax,8)
...
-   1800fbf1b:	add    %bh,-0x80(%rdi,%rax,8)
...
-   1800fc1a4:	(bad)
-   1800fc1a5:	add    $0x37,%bh
-   1800fc1a8:	jns    0x1800fc18c
-   1800fc1aa:	rorl   -0x7b(%rbp)
-   1800fc1ad:	int    $0x58
-   1800fc1af:	loop   0x1800fc1c3
-   1800fc1b1:	sbb    $0x1b77c,%eax
...
## Comparing `sqlite_fastrand-0.2.1a6.dist-info/METADATA` & `sqlite_fastrand-0.2.1a7.dist-info/METADATA`
