# Comparing `tmp/watchmen_cli-16.5.6.tar.gz` & `tmp/watchmen_cli-16.5.7.tar.gz`
...
## Comparing `watchmen_cli-16.5.6.tar` & `watchmen_cli-16.5.7.tar`
...
### Comparing `watchmen_cli-16.5.6/pyproject.toml` & `watchmen_cli-16.5.7/pyproject.toml`
...
### Comparing `watchmen_cli-16.5.6/src/watchmen_cli/common/client.py` & `watchmen_cli-16.5.7/src/watchmen_cli/common/client.py`

 * *Files identical despite different names*

### Comparing `watchmen_cli-16.5.6/src/watchmen_cli/common/constants.py` & `watchmen_cli-16.5.7/src/watchmen_cli/common/constants.py`

 * *Files identical despite different names*

### Comparing `watchmen_cli-16.5.6/src/watchmen_cli/main.py` & `watchmen_cli-16.5.7/src/watchmen_cli/main.py`

 * *Files identical despite different names*

### Comparing `watchmen_cli-16.5.6/src/watchmen_cli/service/deployment.py` & `watchmen_cli-16.5.7/src/watchmen_cli/service/deployment.py`

 * *Files identical despite different names*

### Comparing `watchmen_cli-16.5.6/src/watchmen_cli/service/rerun.py` & `watchmen_cli-16.5.7/src/watchmen_cli/service/rerun.py`

 * *Files identical despite different names*

### Comparing `watchmen_cli-16.5.6/src/watchmen_cli/settings.py` & `watchmen_cli-16.5.7/src/watchmen_cli/settings.py`

 * *Files identical despite different names*

### Comparing `watchmen_cli-16.5.6/PKG-INFO` & `watchmen_cli-16.5.7/PKG-INFO`
