# Comparing `tmp/lazysdk-0.1.5.tar.gz` & `tmp/lazysdk-0.1.6.tar.gz`
...
### Comparing `lazysdk-0.1.5/README.md` & `lazysdk-0.1.6/README.md`
...
### Comparing `lazysdk-0.1.5/lazysdk/lazymd5.py` & `lazysdk-0.1.6/lazysdk/lazymd5.py`
